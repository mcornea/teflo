...
latex_documents = [
    (master_doc, 'Teflo.tex', u'Teflo Documentation',
...
man_pages = [
    (master_doc, 'teflo', u'Teflo Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Teflo', u'Teflo Documentation',
     author, 'Teflo', 'One line description of project.',
     'Miscellaneous'),
]
